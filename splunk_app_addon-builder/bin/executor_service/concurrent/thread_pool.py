...
import aob.aob_common.logger as log

logger = log.get_builder_util_logger()
...
class ThreadPool(object):
    ...
    def _do_resize_according_to_loads(self):
        ...
        if work_size and work_size > free_thrs:
            ...
            if old_div(work_size, free_thrs) < self._low_watermark and free_thrs >= 2:
                thr_size = thr_size - old_div(free_thrs, 2)
